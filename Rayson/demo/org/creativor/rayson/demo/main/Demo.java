...
public class Demo {
	...
	public static void main(String[] args) throws IllegalServiceException,
		...
		DemoProxy testRpcService = Rayson.createProxy("demo", DemoProxy.class,
				serverAddress);
		...
		DemoAsyncProxy asyncProxy = Rayson.createAsyncProxy("demo",
				DemoAsyncProxy.class, serverAddress);
